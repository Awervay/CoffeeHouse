    ...
    public partial class InitGuid : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeeChains", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoffeeChainId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Branches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Branches_CoffeeChains_CoffeeChainId",
                        column: x => x.CoffeeChainId,
                        principalTable: "CoffeeChains",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchProductId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItems_BranchProducts_BranchProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_CoffeeChainId",
                table: "Branches",
                column: "CoffeeChainId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_BranchProductId",
                table: "OrderItems",
